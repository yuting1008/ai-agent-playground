...
import { products } from '../utils/conversation_config';
import { getJsonData } from '../utils/openai';

export const definition: ToolDefinitionType = {
  name: 'products_recommend',
  description: 'Retrieves the food to eat, recommend fast food and food. you can recommend food url. respond wait message to the user before calling the tool.',
  parameters: {
    type: 'object',
    properties: {
      requirements: {
